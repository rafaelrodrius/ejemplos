/*
 * Ejemplo TextArray n° 1
 * Autor: Fernando Yurisich <fyurisich@oohg.org>
 * Licenciado bajo The Code Project Open License (CPOL) 1.02
 * Ver <http://www.codeproject.com/info/cpol10.aspx>
 *
 * Este ejemplo muestra cómo utilizar un control TextArray
 * para simular la ventana de salida de una consola.
 *
...
FUNCTION Main
   ...
   DEFINE WINDOW Form_1 ;
      ...
      @ 400, 520 BUTTON btn ;
         CAPTION "probame" ;
         ACTION oTxtArr:QQOut( "Nuevo texto" ) ;
         WIDTH 80
