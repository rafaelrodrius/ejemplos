 ...
 *
 * Este ejemplo muestra cómo un Grid puede editarse en forma
 ...
 * que corresponda (cláusula EDITLIKEEXCEL). Lo mismo ocurre
 * cuando se hace clic fuera de la celda de edición (cláusula
 * NOMODALEDIT). En lugar de habilitar este comportamiento
 * para todo el Grid, es posible habilitarlo control por
 * control. Note como el comportamiento del método EditGrid
 * es diferente del comportamiento del método EditCell. Para
 * habilitar la edición completa de la celda oprima F2 (como
 * en Excel).
 *
