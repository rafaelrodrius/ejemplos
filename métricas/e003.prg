/*
 * Ejemplo Métricas de Windows n° 3
 * Autor: Fernando Yurisich <fyurisich@oohg.org>
 * Licenciado bajo The Code Project Open License (CPOL) 1.02
 * Ver <http://www.codeproject.com/info/cpol10.aspx>
 *
 * Este ejemplo muestra cómo obtener los colores del sistema.
 *
...
FUNCTION ObtenerColorDelSistema( nColor )
...
FUNCTION MostrarColor
   ...
   aColor := ObtenerColorDelSistema( hColors[ hColors:Keys[ oCombo:Value ] ] )
