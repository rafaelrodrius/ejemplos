 ...
 *
 * Este ejemplo muestra cómo editar un Grid sin utilizar el
 * teclado para aceptar o cancelar el ingreso de datos.
 *
...
*/
      ...
      @ 320,10 LABEL Label_1 ;
         VALUE "Vea lo que sucede cuando edita una celda." ;
         AUTOSIZE
